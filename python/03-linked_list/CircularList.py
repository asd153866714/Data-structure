...
def delete_f():
    ...
    if head.next == head:
        ...
        prev = head
        current = head.next
        while current != head and del_name != current.name: # none -> head
            prev = current
            current = current.next
        if current != head:
...
def modify_f():
    ...
    if head.next == head:
        ...
        prev = head
        current = head.next
        while current != head and modify_name != current.name: # none -> head
            prev = current
            current = current.next
